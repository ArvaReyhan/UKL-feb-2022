...
$Connectpath .= "/ukl/utils/connect.php";
require($Connectpath);
...
<link rel="stylesheet" type="text/css" href="/ukl/Styles/table.css">
    <meta charset="UTF-8">
...
<div class="all-table"> 
    ...
    <button class="btn btn-outline-secondary " name="logout"><a href="/ukl/login-logout/logout.php">Logout</a></button>
