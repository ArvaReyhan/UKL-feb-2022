...
<html>
    ...
    <link rel="stylesheet" type="text/css" href="/ukl/Styles/index.css">  
          ...
          <div class="mm-par-wrap">
            <div class="mm-parallax" data-tilt data-tilt-max="4" >
              ...
              if($_SESSION['level'] == "admin"){
                echo "<div class=\"bg\" data-bg=\"https://wallpapercave.com/wp/wp4939880.png\" style=\"background-image: url(https://wallpapercave.com/wp/wp4939880.png);\">";
                echo "</div>";
              }elseif($_SESSION['level'] == "petugas"){
                echo "<div class=\"bg\" data-bg=\"https://wallpapercave.com/wp/wp4939880.png\" style=\"background-image: url(https://wallpapercave.com/wp/wp4939880.png);\">";
                echo "</div>";
              }else{
                echo "<div class=\"bg\" data-bg=\"/Assets/index_walpaper.jpg\" style=\"background-image: url(/Assets/index_wallpaper.jpg);\">";
                echo "</div>";
              }
              ?>
